...
use ENI\QCM\Bundle\StagiaireBundle\Entity\Test;
use ENI\QCM\Bundle\StagiaireBundle\Form\TestType;
...
class TestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmStagiaireBundle:Test')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmStagiaireBundle:Test:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmStagiaireBundle:Test')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmStagiaireBundle:Test:edit.html.twig")
     */
