...
use ENI\QCM\Bundle\StagiaireBundle\Entity\Status;
use ENI\QCM\Bundle\StagiaireBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmStagiaireBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmStagiaireBundle:Status:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmStagiaireBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmStagiaireBundle:Status:edit.html.twig")
     */
