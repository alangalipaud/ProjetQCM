...
use ENI\QCM\Bundle\StagiaireBundle\Entity\Question;
use ENI\QCM\Bundle\StagiaireBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmStagiaireBundle:Question')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmStagiaireBundle:Question:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmStagiaireBundle:Question')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmStagiaireBundle:Question:edit.html.twig")
     */
