...
use ENI\QCM\Bundle\StagiaireBundle\Entity\Answer;
use ENI\QCM\Bundle\StagiaireBundle\Form\AnswerType;
...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmStagiaireBundle:Answer')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmStagiaireBundle:Answer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmStagiaireBundle:Answer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmStagiaireBundle:Answer:edit.html.twig")
     */
