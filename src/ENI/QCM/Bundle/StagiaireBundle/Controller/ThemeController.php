...
use ENI\QCM\Bundle\StagiaireBundle\Entity\Theme;
use ENI\QCM\Bundle\StagiaireBundle\Form\ThemeType;
...
class ThemeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmStagiaireBundle:Theme')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmStagiaireBundle:Theme:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmStagiaireBundle:Theme')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmStagiaireBundle:Theme:edit.html.twig")
     */
