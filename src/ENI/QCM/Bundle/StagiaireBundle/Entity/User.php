...
class User
{
     ...
     *
     * @ORM\ManyToOne(targetEntity="ENI\QCM\Bundle\StagiaireBundle\Entity\Status")
     * @ORM\JoinColumns({
     ...
     * Set statusid
     *
     * @param \ENI\QCM\Bundle\StagiaireBundle\Entity\Status $statusid
     *
     * @return User
     */
    public function setStatusid(\ENI\QCM\Bundle\StagiaireBundle\Entity\Status $statusid = null)
    {
     ...
     * Get statusid
     *
     * @return \ENI\QCM\Bundle\StagiaireBundle\Entity\Status
     */
