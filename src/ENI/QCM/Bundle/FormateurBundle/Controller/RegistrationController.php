...
use ENI\QCM\Bundle\FormateurBundle\Entity\Registration;
use ENI\QCM\Bundle\FormateurBundle\Form\RegistrationType;
...
class RegistrationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmFormateurBundle:Registration')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmFormateurBundle:Registration:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmFormateurBundle:Registration')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmFormateurBundle:Registration:edit.html.twig")
     */
