...
use ENI\QCM\Bundle\FormateurBundle\Form\ThemeType;
...
class ThemeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmFormateurBundle:Theme')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmFormateurBundle:Theme:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmFormateurBundle:Theme')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmFormateurBundle:Theme:edit.html.twig")
     */
