...
use ENI\QCM\Bundle\FormateurBundle\Entity\Answer;
use ENI\QCM\Bundle\FormateurBundle\Form\AnswerType;
...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmFormateurBundle:Answer')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmFormateurBundle:Answer:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmFormateurBundle:Answer')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmFormateurBundle:Answer:edit.html.twig")
     */
