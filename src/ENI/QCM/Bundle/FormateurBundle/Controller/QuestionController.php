...
use ENI\QCM\Bundle\FormateurBundle\Entity\Question;
use ENI\QCM\Bundle\FormateurBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmFormateurBundle:Question')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmFormateurBundle:Question:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmFormateurBundle:Question')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmFormateurBundle:Question:edit.html.twig")
     */
