...
use ENI\QCM\Bundle\FormateurBundle\Entity\Currenttest;
use ENI\QCM\Bundle\FormateurBundle\Form\CurrenttestType;
...
class CurrenttestController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmFormateurBundle:Currenttest')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmFormateurBundle:Currenttest:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmFormateurBundle:Currenttest')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmFormateurBundle:Currenttest:edit.html.twig")
     */
