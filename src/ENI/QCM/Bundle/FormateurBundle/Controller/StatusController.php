...
use ENI\QCM\Bundle\FormateurBundle\Entity\Status;
use ENI\QCM\Bundle\FormateurBundle\Form\StatusType;
...
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmFormateurBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmFormateurBundle:Status:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmFormateurBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmFormateurBundle:Status:edit.html.twig")
     */
