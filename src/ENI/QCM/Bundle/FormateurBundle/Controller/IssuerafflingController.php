...
use ENI\QCM\Bundle\FormateurBundle\Entity\Issueraffling;
use ENI\QCM\Bundle\FormateurBundle\Form\IssuerafflingType;
...
class IssuerafflingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EniQcmFormateurBundle:Issueraffling')->findAll();
     ...
     * @Method("POST")
     * @Template("EniQcmFormateurBundle:Issueraffling:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EniQcmFormateurBundle:Issueraffling')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EniQcmFormateurBundle:Issueraffling:edit.html.twig")
     */
